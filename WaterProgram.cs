...
namespace SimulatedDevice
{
    ...
    internal class WaterProgram
    {
        ...
        private static string s_connectionString = "HostName=newiothub3.azure-devices.net;DeviceId=Wafer_SimulatorDevice;SharedAccessKey=Zll8MlVhOHumb0kK6f4IIkEiLtdGOtcgPnh8MNrarN8=";
		

        private static async Task Main(string[] args)
        {
            Console.WriteLine("IoT Hub Quickstarts #2 - Simulated device.");
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            {
                double currentWater = minWater + rand.NextDouble() * 15;
                ...
                message.Properties.Add("temperatureAlert", (currentWater > 30) ? "true" : "false");
